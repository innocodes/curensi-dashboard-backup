...
const PAYSTACK_SECRET_KEY = ((_a = functions.config().paystack) === null || _a === void 0 ? void 0 : _a.secret_key) || process.env.PAYSTACK_SECRET_KEY;
...
exports.handlePaystackWebhook = functions.https.onRequest(async (req, res) => {
    ...
    const secret = ((_a = functions.config().paystack) === null || _a === void 0 ? void 0 : _a.webhook_secret) || process.env.PAYSTACK_WEBHOOK_SECRET;
    if (!hash || !secret) {
...
exports.initializePaystackPlans = functions.https.onCall(async (data, context) => {
    var _a, _b, _c;
